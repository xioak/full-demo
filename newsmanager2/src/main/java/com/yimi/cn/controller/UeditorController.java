...
public class UeditorController {
    ...
    public void updload2(HttpServletRequest request, HttpServletResponse response, String fileTypes, @RequestParam("upfile") CommonsMultipartFile[] files) {
        ...
        try {
            ...
            if(StringUtils.equals("doc",fileTypes)){
                uploader.setAllowFiles(new String[]{".doc", ".docx"});
            }

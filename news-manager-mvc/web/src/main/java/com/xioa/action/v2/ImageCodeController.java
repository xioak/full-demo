...
public class ImageCodeController {
    ...
    public static final int HEIGHT = 60;//生成的图片的高度
...
//        Font font = new Font("微软雅黑", Font.CENTER_BASELINE, fontHeight);
        g.setFont(getFont(fontHeight-6));
        ...
        for (int i = 0; i < codeCount; i++) {
           ...
           // shear(g,width+30,height+30,getRandColor(1, 255));
            g.drawString(strRand, i * fontWidth+20, codeY);
        }
    }
